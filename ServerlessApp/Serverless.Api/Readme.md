...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Serverless.Api*):
...
Execute unit tests
```
    cd "Serverless.Api/test/Serverless.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Serverless.Api/src/Serverless.Api"
