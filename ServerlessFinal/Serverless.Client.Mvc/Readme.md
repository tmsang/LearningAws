...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Serverless.Client.Mvc*):

Restore dependencies
```
    cd "Serverless.Client.Mvc"
    dotnet restore
```

Execute unit tests
```
    cd "Serverless.Client.Mvc/test/Serverless.Client.Mvc.Tests"
    dotnet test
```

Deploy application
```
    cd "Serverless.Client.Mvc/src/Serverless.Client.Mvc"
