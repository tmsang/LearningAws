...
* Controllers\CatalogItemController - example Web API controller
...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Serverless.Catalog.Api*):

Restore dependencies
```
    cd "Serverless.Catalog.Api"
    dotnet restore
```

Execute unit tests
```
    cd "Serverless.Catalog.Api/test/Serverless.Catalog.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Serverless.Catalog.Api/src/Serverless.Catalog.Api"
