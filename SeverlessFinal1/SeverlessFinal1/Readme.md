...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *SeverlessFinal1*):
...
Execute unit tests
```
    cd "SeverlessFinal1/test/SeverlessFinal1.Tests"
    dotnet test
```

Deploy application
```
    cd "SeverlessFinal1/src/SeverlessFinal1"
