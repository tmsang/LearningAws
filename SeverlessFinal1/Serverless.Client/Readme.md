...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Serverless.Client*):
...
Execute unit tests
```
    cd "Serverless.Client/test/Serverless.Client.Tests"
    dotnet test
```

Deploy application
```
    cd "Serverless.Client/src/Serverless.Client"
